...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->can('admin_general_dashboard_show')) {
            $getActiveSubscriptionPlanStatistics = $this->getActiveSubscriptionPlanStatistics();
            $getTotalWalletRechargeStatistics = $this->getTotalWalletRechargeStatistics();
        }
        ...
        $data = [
            ...
            'getActiveSubscriptionPlanStatistics' => $getActiveSubscriptionPlanStatistics ?? null,
            'getTotalWalletRechargeStatistics' => $getTotalWalletRechargeStatistics ?? null,
