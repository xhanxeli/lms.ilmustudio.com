...
class SalesApiClient extends Model
{
    protected $table = 'sales_api_clients';
    ...
    /**
     * @return array{0: SalesApiClient, 1: string} Client and plain-text secret (show once)
     */
