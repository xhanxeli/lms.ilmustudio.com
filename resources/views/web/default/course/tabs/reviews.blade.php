{{-- Reviews summary box hidden on frontend --}}
{{-- <div class="mt-35">
...
{{-- <section class="mt-40">
    ...
    {{-- Comments section hidden on frontend --}}
    {{-- <div class="mt-45">
