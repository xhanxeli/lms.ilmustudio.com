                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="invoice-title">
                                                            @if(!empty($generalSettings['logo']))
                                                                <img src="{{ $generalSettings['logo'] }}" alt="Logo" style="max-height: 60px; max-width: 200px;">
                                                            @else
                                                                <h2>{{ $generalSettings['site_name'] ?? 'IlmuStudio Online Class' }}</h2>
                                                            @endif
                                                            ...
                                                            <table class="table table-striped table-hover table-md">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        @php
                                                                            // For subscription purchases, show the webinar price instead of 0
                                                                            if (!empty($orderItem)) {
                                                                                $price = $orderItem->amount;
                                                                            } elseif ($sale->payment_method == \App\Models\Sale::$subscribe && !empty($webinar->price)) {
                                                                                $price = $webinar->price;
                                                                            } else {
                                                                                $price = $sale->amount ?? 0;
                                                                            }
                                                                    ...
                                                                    <td class="text-center">
                                                                        @php
                                                                            $discount = !empty($orderItem) ? $orderItem->discount : ($sale->discount ?? 0);
                                                                        @endphp
                                                                        @if(!empty($discount))
                                                            ...
                                                            <div class="col-lg-12 text-right">
                                                                @php
                                                                    ...
                                                                    if (!empty($orderItem)) {
                                                                        ...
                                                                        $tax = $orderItem->tax_price ?? 0;
                                                                        $discount = $orderItem->discount ?? 0;
                                                                        $totalAmount = $orderItem->total_amount;
                                                                    } elseif ($sale->payment_method == \App\Models\Sale::$subscribe && !empty($webinar->price)) {
                                                                        // For subscription purchases, show webinar price
                                                                ...
                                                                <div class="invoice-detail-item">
                                                                    ...
                                                                    <div class="invoice-detail-value">{{ handlePrice($subTotal) }}</div>
                                                                </div>
                                                                <div class="invoice-detail-item">
