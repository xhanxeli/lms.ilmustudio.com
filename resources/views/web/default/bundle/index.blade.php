                        ...
                        <form action="/cart/store" method="post">
                            ...
                            <div class="mt-20 d-flex flex-column">
                                @if($hasBought or !empty($bundle->getInstallmentOrder()))
                                    <a target="_blank" href="{{ $bundle->getUrl() }}" class="btn btn-primary">{{ trans('update.go_to_learning_page') }}</a>
                                ...
                                @if($canSale and $bundle->subscribe)
                                    @if($hasBought)
                                        <a target="_blank" href="{{ $bundle->getUrl() }}" class="btn btn-primary mt-20">{{ trans('update.go_to_learning_page') }}</a>
                                    @else
