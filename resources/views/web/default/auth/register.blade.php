                ...
                <div class="login-card">
                    ...
                    <form method="post" action="/register" class="mt-35">
                        ...
                        @if(!empty($referralSettings) and $referralSettings['status'])
                            <div class="form-group ">
                                <label class="input-label" for="referral_code">{{ trans('financial.referral_code') }}: <span class="text-danger">*</span></label>
                                <small class="form-text text-muted d-block mb-2">Get your Referral code from our admin</small>
