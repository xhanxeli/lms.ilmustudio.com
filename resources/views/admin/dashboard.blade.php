...
@section('content')
    ...
    <section class="section">
                        ...
                        <div class="card card-statistic-2">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('admin/main.daily_sales')}} (Subscription Plan)</h4>
                                </div>
                                <div class="card-body">
                                    {{ handlePrice($dailySalesTypeStatistics['todaySalesAmount'] ?? 0) }}
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                @can('admin_general_dashboard_income_statistics')
                    @if(!empty($getIncomeStatistics))
                        <div class="card card-statistic-2">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('admin/main.monthly_sales')}} (Subscription Plan)</h4>
                                </div>
                                <div class="card-body">
                                    {{ handlePrice($getIncomeStatistics['monthlySalesAmount'] ?? 0) }}
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                @can('admin_general_dashboard_total_sales_statistics')
                    @if(!empty($getTotalSalesStatistics))
                        <div class="card card-statistic-2">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('admin/main.total_sales')}} (Subscription Plan)</h4>
                                </div>
                                <div class="card-body">
                                    {{ handlePrice($getTotalSalesStatistics['totalSalesAmount'] ?? 0) }}
                                </div>
                            </div>
                        </div>
                    @endif
        ...
        @can('admin_general_dashboard_show')
            @if(!empty($getActiveSubscriptionPlanStatistics) || !empty($getTotalWalletRechargeStatistics))
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        @if(!empty($getActiveSubscriptionPlanStatistics))
                            <div class="card card-statistic-2">
                                ...
                                <div class="card-wrap">
                                    <div class="card-header">
                                        <h4>{{ trans('admin/main.dashboard_daily_active_subscription_plans') }}</h4>
                                    </div>
                                    <div class="card-body">
                                        {{ number_format($getActiveSubscriptionPlanStatistics['todayNewSubscribePlansCount'] ?? 0) }}
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        @if(!empty($getActiveSubscriptionPlanStatistics))
                            <div class="card card-statistic-2">
                                ...
                                <div class="card-wrap">
                                    <div class="card-header">
                                        <h4>{{ trans('admin/main.dashboard_monthly_active_subscription_plans') }}</h4>
                                    </div>
                                    <div class="card-body">
                                        {{ number_format($getActiveSubscriptionPlanStatistics['activeSubscribersCount'] ?? 0) }}
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        @if(!empty($getTotalWalletRechargeStatistics))
                            <div class="card card-statistic-2">
                                ...
                                <div class="card-wrap">
                                    <div class="card-header">
                                        <h4>{{ trans('admin/main.dashboard_total_wallet_recharge') }}</h4>
                                    </div>
                                    <div class="card-body">
                                        {{ handlePrice($getTotalWalletRechargeStatistics['totalRecharged'] ?? 0) }}
                                    </div>
                                </div>
                            </div>
                        @endif
        ...
        <div class="row">
            ...
            {{-- User Registration Statistics card removed --}}
...
@push('scripts_bottom')
    ...
    <script>
        (function ($) {
            ...
            {{-- Sales Statistics chart removed --}}
            ...
            {{-- User Registration Statistics chart removed --}}
