<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="/">
                @if(!empty($generalSettings['logo']))
                    <img src="{{ $generalSettings['logo'] }}" alt="{{ $generalSettings['site_name'] ?? 'Logo' }}" style="max-height: 40px; max-width: 100%; margin-top: 10px;">
                @elseif(!empty($generalSettings['site_name']))
        ...
        <ul class="sidebar-menu">
            ...
            {{-- DECOMMISSIONED: User requested to remove marketing dashboard menu --}}
            ...
            {{-- Admin assignments module removed --}}
            ...
            {{-- Admin Appointments / Consultants modules removed (not used) --}}
            ...
            <li class="nav-item {{ (request()->is(getAdminPanelUrl('/file-manager*', false))) ? 'active' : '' }}">
                <a href="{{ getAdminPanelUrl() }}/file-manager" class="nav-link">
                    <i class="fas fa-folder-open"></i>
                    <span>{{ trans('admin/main.file_manager') }}</span>
                </a>
            </li>
            ...
            @can('admin_referrals')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/referrals*', false))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_referrals_api_keys')
                            <li class="{{ (request()->is(getAdminPanelUrl('/referrals/api-access*', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/referrals/api-access">{{ trans('admin/main.affiliate_api_keys') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
