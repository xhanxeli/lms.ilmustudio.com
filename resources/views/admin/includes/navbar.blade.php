    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-list-toggle">
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    <div class="dropdown-list-icons mb-0" height="150px">
                            <a href="https://ilmustudio.com" class="dropdown-item">
                                <div class="dropdown-item-icon bg-info text-white d-flex align-items-center justify-content-center">
                                    <i class="fa fa-info"></i>
                                </div>
                                <div class="dropdown-item-desc">
                                   Develop for ilmuStudio.com
                                   <div class="time text-primary">All rights reserved for IS EDUCATION NETWORK SDN BHD</div>
                                </div>
                            </a>
                    </div>
                </div>
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                {{-- DECOMMISSIONED: User requested to remove "Show website" from user dropdown --}}
