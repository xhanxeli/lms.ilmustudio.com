                        ...
                        <form action="{{ getAdminPanelUrl() }}/financial/documents" method="get" class="row mb-0">
                            ...
                            <div class="col-12 col-md-3 d-flex align-items-center justify-content-end">
                                <div class="d-flex w-100">
                                    <button type="submit" class="btn btn-primary flex-grow-1 mr-2">{{ trans('admin/main.show_results') }}</button>
                                    <button type="submit"
                                            class="btn btn-danger flex-grow-1"
                                            formaction="{{ getAdminPanelUrl() }}/financial/documents/excel"
                                            formmethod="get">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('admin/main.payment_source') }}</th>
