                            ...
                            <form action="{{ getAdminPanelUrl() }}/financial/subscribes/{{ !empty($subscribe) ? $subscribe->id.'/update' : 'store' }}" method="Post">
                                ...
                                <div class="form-group mt-3">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="trialSwitch" name="trial" value="1" {{ (isset($subscribe) && $subscribe->trial) ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="trialSwitch">Trial Package (can be subscribed only once per user)</label>
                                    </div>
                                </div>

                                <div class="form-group mt-3">
                                    <label class="input-label">{{ trans('public.categories') }} ({{ trans('admin/main.optional') }})</label>
                                    <p class="font-12 text-gray mt-1 mb-0">{{ trans('admin/main.subscribe_categories_hint') }}</p>
