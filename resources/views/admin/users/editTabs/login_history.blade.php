        ...
        <div class="col-12">
            ...
            <div class="table-responsive mt-5">
                <table class="table table-striped font-14">
                    ...
                    @if(!empty($userLoginHistories) && $userLoginHistories->count() > 0)
                    ...
                    @else
                        <tr>
                            <td colspan="11" class="text-center py-20">
                                <div class="text-gray font-14">{{ trans('admin/main.no_result') ?? 'No login history records found for this user.' }}</div>
                            </td>
                        </tr>
                    @endif
                </table>
