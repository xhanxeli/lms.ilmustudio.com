            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <div class="card-body">
                            {{ $totalClassesPurchased }}<br>
                            {{-- <span class="text-small font-600-bold">{{ handlePrice($totalClassesPurchasedSum) }}</span> --}}
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="input-label">{{ trans('admin/main.search') }} ({{ trans('admin/main.name') }}, {{ trans('admin/main.email') }} & {{ trans('admin/main.mobile') }})</label>
