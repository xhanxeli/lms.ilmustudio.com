        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="GET" action="{{ getAdminPanelUrl() }}/users/groups" class="mb-4">
                                <div class="input-group">
                                    <input type="text" name="name" class="form-control" placeholder="Search by group name" value="{{ $group_name }}">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary" type="submit">
                                            <i class="fas fa-search"></i> {{ trans('admin/main.search') }}
                                        </button>
                                        @if(!empty($group_name))
                                            <a href="{{ getAdminPanelUrl() }}/users/groups" class="btn btn-secondary">
