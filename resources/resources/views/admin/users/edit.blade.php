                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="subscription_plans-tab" data-toggle="tab" href="#subscription_plans" role="tab" aria-controls="subscription_plans" aria-selected="true">{{ trans('financial.subscribe_plans') }}</a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                @include('admin.users.editTabs.subscription_plans')
