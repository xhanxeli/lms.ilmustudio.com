...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['impersonate', 'panel', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::group(['prefix' => 'webinars'], function () {
        ...
        Route::group(['prefix' => 'purchases'], function () {
            ...
            Route::get('/expired-subjects', 'WebinarController@expiredSubjects');
            Route::post('/getJoinInfo', 'WebinarController@getJoinInfo');
            Route::post('/resubscribe-all', 'WebinarController@resubscribeAllExpired');
            Route::post('/resubscribe-single', 'WebinarController@resubscribeSingle');
            Route::post('/resubscribe-selected', 'WebinarController@resubscribeSelected');
        });
    ...
    Route::group(['prefix' => 'financial'], function () {
        ...
        Route::get('/summary/charge-account/{id}/invoice', 'AccountingController@chargeAccountInvoice');
        ...
        Route::group(['prefix' => 'subscribes'], function () {
            ...
            Route::post('/coupon/validate', 'SubscribesController@couponValidate');
            Route::post('/coupon/apply-to-order', 'SubscribesController@applyCouponToOrder');
            // Auto-renew functionality removed
            // Route::post('/auto-renew', 'SubscribesController@toggleAutoRenew');
        });
