...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            Route::post('/{id}/updateSubscriptionExpiration', 'UserController@updateSubscriptionExpiration');
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::post('/{id}/toggle-live-now', 'WebinarController@toggleLiveNow');
        ...
        // Admin assignments module - listing/management routes removed, keeping CRUD routes for course creation
        Route::group(['prefix' => 'assignments'], function () {
            // Route::get('/', 'AssignmentController@index'); // Removed - assignments listing page
            // Route::get('/{id}/students', 'AssignmentController@students'); // Removed - students management
            // Route::get('/{assignmentId}/history/{historyId}/conversations', 'AssignmentController@conversations'); // Removed - conversations
            Route::post('/store', 'AssignmentController@store'); // Kept - for course creation
            Route::post('/{id}/edit', 'AssignmentController@edit'); // Kept - for course creation
            Route::post('/{id}/update', 'AssignmentController@update'); // Kept - for course creation
            Route::get('/{id}/delete', 'AssignmentController@destroy'); // Kept - for course creation
        });
        ...
        /*
         |----------------------------------------------------------------------
         | Admin Appointments / Consultants modules (DECOMMISSIONED)
         |----------------------------------------------------------------------
         | These modules are not used by Ilmustudio. Routes are disabled to
         | prevent accidental access without removing shared meeting features.
         */
        ...
        Route::group(['prefix' => 'financial'], function () {
            ...
            Route::group(['prefix' => 'sales'], function () {
                ...
                Route::get('/{id}/cancel', 'SaleController@cancel');
                Route::get('/export', 'SaleController@exportExcel');
                Route::group(['prefix' => 'api-access'], function () {
                    Route::get('/', 'SalesApiController@index');
                    Route::post('/store', 'SalesApiController@store');
                    Route::get('/{id}/toggle', 'SalesApiController@toggle');
                    Route::get('/{id}/regenerate', 'SalesApiController@regenerate');
                    Route::get('/{id}/delete', 'SalesApiController@destroy');
                });
            });
            ...
            Route::group(['prefix' => 'documents'], function () {
                ...
                Route::get('/excel', 'DocumentController@exportExcel');
        ...
        Route::group(['prefix' => 'referrals'], function () {
            ...
            Route::group(['prefix' => 'api-access'], function () {
                Route::get('/', 'AffiliateApiController@index');
                Route::post('/store', 'AffiliateApiController@store');
                Route::get('/{id}/toggle', 'AffiliateApiController@toggle');
                Route::get('/{id}/regenerate', 'AffiliateApiController@regenerate');
                Route::get('/{id}/delete', 'AffiliateApiController@destroy');
            });
        });
